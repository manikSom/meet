...
const credentials = {
  ...
  redirect_uris: ['https://maniksom.github.io/meet/'],
  javascript_origins: ['https://maniksom.github.io', 'http://localhost:3000','http://localhost:8080'],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  // access_token is integrated in this new function
  oAuth2Client.setCredentials({ access_token });

  return new Promise((resolve, reject) => {
    //this method will get list of events from fullstackwebdev using oAuth2Client
    ...
    .then((results) => {
      // this is what is executed when promise is resolved
      return {
        statusCode: 200,
        headers: {
          'Access-Control-Allow-Origin': '*',
